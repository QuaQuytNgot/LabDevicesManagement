...
int main(){
    ...
    for(;;)
    {
        ...
        if(user_choice == "borrow")         choice = 1;
        else if(user_choice == "sort")    choice = 2;
        else if(user_choice == "search")      choice = 3;
        else if(user_choice == "print")     choice = 4;
        else if(user_choice == "help")      choice = 5;
        else
        {
        ...
        case 1:
        {
            ...
            if(case_1 == "borrow")      x = 1;
            else if(case_1 == "show")   x = 2;
            else if(case_1 == "return") x = 3;
            else if(case_1 == "back")   x = 4;
            else 
            {
