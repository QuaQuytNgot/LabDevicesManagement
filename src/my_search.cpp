...
int read_csv(const string& filename, device_info devices[], int max_size) {
...
void search_device_name(device_info a[], int size) {
    ...
    if (!found) cout << "No result matches value: " << name << endl;
}
...
void search_device_ID(device_info a[], int size) {
    ...
    if (!found) cout << "No result matches value: " << ID << endl;
}
...
void search_device_cost(device_info a[], int size) {
    ...
    if (!found)  cout << "No result matches value: " << cost <<  endl;
}
...
void search_category(device_info a[], int size) {
    ...
    if (!found)  cout << "No result matches value: " << category <<  endl;
}