...
int main()
{
  ...
  for (;;) {
    ...
    switch (choice) {
      ...
      case 1: {
        int x = 0;
        cout << "Please enter one of these options: 'borrow', 'show', 'return' "
                "or 'back'\n";
        cin >> case_1;
        cin.ignore();
      ...
      case 2:
        cout << "--------------------------------------------------------\n"
             ...
             << "Please enter '1' for sort by name or '2' for sort by category "
                "or '3' for back to menu\n";
        int x;
        cin >> x;
        cin.ignore();
        switch (x) {
      ...
      case 3:
        cout << "-------------------------------------------\n"
             << "We provide 3 options search: 'search by name', 'search by ID' "
                "and 'search by category' and 1 for 'back to menu'\n"
             << "Please enter '1', '2', '3' or '4' for each of above options, "
                "respectively!\n";
        int y;
        cin >> y;
        cin.ignore();
      ...
      case 4:
        cout << "-------------------------------------------\n"
             << "We provide 3 options print: 'print all devices', 'print a "
                "single device' and 'back to menu'\n"
             << "Please enter '1', '2' or '3' for each of above options, "
                "respectively!\n";
        int z;
        cin >> z;
        cin.ignore();
